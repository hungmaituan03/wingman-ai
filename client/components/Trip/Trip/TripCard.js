...
import createTripCardStyles from "./TripCard.styles";
...
export default function TripCard(props) {
  ...
  const styles      = createTripCardStyles(colors);
        ...
        {google_maps_url && (
          ...
          >
            <Ionicons
              name="map-outline"
              size={18}
              color={colors.primary}  // high contrast
            />
          </TouchableOpacity>
        )}
